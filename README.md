...
**$ FallAdviser · sovereign US finance · tax · retirement account · portfolio** — sovereign SDK extracted from `falladviser-us/index.html`.

## Install
```bash
npm install @ai-native-solutions/falladviser-us-sdk
```

## Use
```js
import * as falladviser-us from '@ai-native-solutions/falladviser-us-sdk';
```

- Playground: https://sjgant80-hub.github.io/falladviser-us-sdk/
- MCP wrapper: [`@ai-native-solutions/falladviser-us-mcp`](https://github.com/sjgant80-hub/falladviser-us-mcp)
- HTTP API: [`@ai-native-solutions/falladviser-us-api`](https://github.com/sjgant80-hub/falladviser-us-api)
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=falladviser-us-sdk](https://sjgant80-hub.github.io/fallmarket/listing.html?id=falladviser-us-sdk)
...
- **Companion SDK** (`npm install @ai-native-solutions/falladviser-us-sdk-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add falladviser-us-sdk -- npx -y @ai-native-solutions/falladviser-us-sdk-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/falladviser-us-sdk-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=falladviser-us-sdk
- **Live URL**: https://sjgant80-hub.github.io/falladviser-us-sdk/
- **Source**: https://github.com/sjgant80-hub/falladviser-us-sdk
